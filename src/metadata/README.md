 ...
 * [elmo.yml](elmo.yml)
     * Determines how your purl.obolibrary.org/obo/elmo/ redirects will be handled
     ...
     * Paste in the contents of [elmo.yml](elmo.yml)
 ...
 * [elmo.md](elmo.md)
     ...
     * Paste in the contents of [elmo.md](elmo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
