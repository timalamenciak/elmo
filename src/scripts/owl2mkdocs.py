...
Note that this only works with ELMO - some things need to change to work with other ontologies.
"""
...
def main():
    ...
    # Get class from command line argument or list top classes
    ...
    #The below namespace definitions would need to change to work with a different ontology
    ...
    #Write to a csv file
    output_file_path = f'../../docs/elmo.html'
